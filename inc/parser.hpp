...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOKEN_COMMA = 263,             /* TOKEN_COMMA  */
    TOKEN_DOT = 264,               /* TOKEN_DOT  */
    TOKEN_COLON = 265,             /* TOKEN_COLON  */
    TOKEN_DOLLAR = 266,            /* TOKEN_DOLLAR  */
    TOKEN_PERCENT = 267,           /* TOKEN_PERCENT  */
    TOKEN_NUM = 268,               /* TOKEN_NUM  */
